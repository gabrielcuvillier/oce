...
if (ENABLE_LTO)
  if (EMSCRIPTEN)
    set(COMPILE_LTO_FLAGS "-s WASM_OBJECT_FILES=0")
    set(LINK_LTO_FLAGS    "-s WASM_OBJECT_FILES=0 --llvm-lto 1")
  else()
...
if (ENABLE_O1)
  ...
  if (IS_O2_CXX)
    ...
    set (CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -O1")
  endif()
  ...
  if (IS_O2_C)
    ...
    set (CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELWITHDEBINFO} -O1")
  endif()
endif()
