...
IMPLEMENT_STANDARD_HANDLE (JtData_Model, Standard_Transient)
...
//=======================================================================
Standard_Boolean JtData_Model::open (std::ifstream& aFile) const
{
#ifdef WNT
  ...
  aFile.open (anAsciiName.ToCString(), std::ios::binary | std::ios::in);
#endif
