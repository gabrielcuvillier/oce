// File duplicated from XSDRAWSTLVRML_DataSource
//
...
#include "MeshVS_Triangulation_DataSource.hxx"
...
IMPLEMENT_STANDARD_RTTIEXT(MeshVS_Triangulation_DataSource,MeshVS_DataSource)

//================================================================
// Function : Constructor
// Purpose  :
//================================================================
MeshVS_Triangulation_DataSource::MeshVS_Triangulation_DataSource (const Handle(Poly_Triangulation)& aMesh)
{
  myMesh = aMesh;
...
// Purpose  :
//================================================================
Standard_Boolean MeshVS_Triangulation_DataSource::GetGeom
...
// Purpose  :
//================================================================
Standard_Boolean MeshVS_Triangulation_DataSource::GetGeomType
...
// Purpose  :
//================================================================
Standard_Address MeshVS_Triangulation_DataSource::GetAddr
...
// Purpose  :
//================================================================
Standard_Boolean MeshVS_Triangulation_DataSource::GetNodesByElement
...
// Purpose  :
//================================================================
const TColStd_PackedMapOfInteger& MeshVS_Triangulation_DataSource::GetAllNodes() const
{
  return myNodes;
}
...
// Purpose  :
//================================================================
const TColStd_PackedMapOfInteger& MeshVS_Triangulation_DataSource::GetAllElements() const
{
  return myElements;
}
...
// Purpose  :
//================================================================
Standard_Boolean MeshVS_Triangulation_DataSource::GetNormal
