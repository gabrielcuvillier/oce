...
#ifndef _MeshVS_Triangulation_DataSource_HeaderFile
#define _MeshVS_Triangulation_DataSource_HeaderFile
...
class MeshVS_Triangulation_DataSource;
DEFINE_STANDARD_HANDLE(MeshVS_Triangulation_DataSource, MeshVS_DataSource)

//! The sample DataSource for working with Poly_Triangulation
class MeshVS_Triangulation_DataSource : public MeshVS_DataSource
{
...
public:
  ...
  //! Constructor
  Standard_EXPORT MeshVS_Triangulation_DataSource(const Handle(Poly_Triangulation)& aMesh);
  ...
  DEFINE_STANDARD_RTTIEXT(MeshVS_Triangulation_DataSource,MeshVS_DataSource)
...
#endif // MeshVS_Triangulation_DataSource
