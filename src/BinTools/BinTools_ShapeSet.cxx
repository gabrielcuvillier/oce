...
//??? Bug?  myBuilder.UpdateEdge(E,Handle(Poly_Polygon3D)::DownCast(myPolygons3D(c)));
      ...
      case TopAbs_WIRE :myBuilder.MakeWire(TopoDS::Wire(S));
        break;
      ...
      case TopAbs_SHELL :myBuilder.MakeShell(TopoDS::Shell(S));
        break;
      ...
      case TopAbs_SOLID :myBuilder.MakeSolid(TopoDS::Solid(S));
        break;
      ...
      case TopAbs_COMPSOLID :myBuilder.MakeCompSolid(TopoDS::CompSolid(S));
        break;
      ...
      case TopAbs_COMPOUND :myBuilder.MakeCompound(TopoDS::Compound(S));
        break;
