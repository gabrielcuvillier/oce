...
#ifndef _HLRAlgo_BRepPolyAlgo_HeaderFile
#define _HLRAlgo_BRepPolyAlgo_HeaderFile
...
DEFINE_STANDARD_HANDLE(HLRAlgo_BRepPolyAlgo, Standard_Transient)
...
//! HLRAlgo_BRepPolyAlgo works with three types of entity:
...
//! HLRAlgo_BRepPolyAlgo is based on the principle
...
//! For a given projection, HLRAlgo_BRepPolyAlgo
...
//! HLRAlgo_BRepPolyAlgo works with a polyhedral
...
//! An HLRAlgo_BRepPolyAlgo object provides a framework for:
...
class HLRAlgo_BRepPolyAlgo : public Standard_Transient {
 ...
 public:
  ...
  Standard_EXPORT HLRAlgo_BRepPolyAlgo();

  Standard_EXPORT HLRAlgo_BRepPolyAlgo(const Handle(HLRAlgo_BRepPolyAlgo) &A);

  Standard_EXPORT HLRAlgo_BRepPolyAlgo(const TopoDS_Shape &S);
 ...
 DEFINE_STANDARD_RTTIEXT(HLRAlgo_BRepPolyAlgo, Standard_Transient)
 ...
 private:
  ...
  Standard_EXPORT void StoreShell(const TopoDS_Shape &Shape,
  ...
  Standard_EXPORT Standard_Boolean Normal(const Standard_Integer iNode,
  ...
  Standard_EXPORT Standard_Boolean AverageNormal(const Standard_Integer iNode,
  ...
  Standard_Boolean AverageNormal(const Standard_Integer iNode,
                                 HLRAlgo_PolyInternalNode::NodeIndices &theNodeIndices,
                                 HLRAlgo_Array1OfTData *&TData,
                                 HLRAlgo_Array1OfPISeg *&PISeg,
                                 HLRAlgo_Array1OfPINod *&PINod,
                                 gp_XYZ &theNormal) const {
    return AverageNormal(iNode,
                         theNodeIndices,
                         TData,
                         PISeg,
                         PINod,
  ...
  Standard_EXPORT void AddNormalOnTriangle(const Standard_Integer iTri,
  ...
  Standard_EXPORT void InitBiPointsWithConnexity(const Standard_Integer e,
                                                 TopoDS_Edge &E,
  ...
  Standard_EXPORT void ChangeNode(const Standard_Integer ip1,
                                  const Standard_Integer ip2,
  ...
  Standard_EXPORT void UpdateAroundNode(const Standard_Integer iNode,
                                        HLRAlgo_PolyInternalNode::NodeIndices &theNodeIndices,
                                        HLRAlgo_Array1OfTData *TData,
                                        HLRAlgo_Array1OfPISeg *PISeg,
                                        HLRAlgo_Array1OfPINod *PINod) const;
  ...
  Standard_EXPORT void UpdateEdgesBiPoints(HLRAlgo_ListOfBPoint &List,
                                           const TColStd_Array1OfTransient &PID,
                                           const Standard_Boolean closed);

  Standard_EXPORT void UpdatePolyData(TColStd_Array1OfTransient &PD,
                                      TColStd_Array1OfTransient &PID,
                                      const Standard_Boolean closed);
...
#include <HLRAlgo_BRepPolyAlgo.lxx>

#endif // _HLRAlgo_BRepPolyAlgo_HeaderFile
